...
export default function ContactForm() {
  ...
  const fieldBorder = (field: string) =>
    focusedField === field ? 'var(--color-accent)' : 'var(--color-border-light)';
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '72px 24px' }}>
          ...
          >
            ...
            <div>
              {submitted ? (
                ...
                >
                  ...
                  <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '24px', color: 'var(--color-text-dark)', marginBottom: '12px' }}>
                    Thank you!
                  </h2>
                  <p style={{ color: 'var(--color-text-dark-muted)', fontSize: '16px', lineHeight: 1.6 }}>
                    We&apos;ll contact you within 1 business day to schedule your free inspection.
                  </p>
                  <p style={{ color: 'var(--color-text-dark-muted)', fontSize: '14px', marginTop: '16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
              {/* Phone */}
              <div>
                <p style={{ fontSize: '12px', letterSpacing: '2px', color: 'var(--color-text-dark-muted)', fontFamily: 'var(--font-display)', fontWeight: 700, textTransform: 'uppercase', marginBottom: '8px' }}>
                  Call or Text
                </p>
                <a
              ...
              <div style={{ borderTop: '1px solid var(--color-border-light)', paddingTop: '24px' }}>
                ...
                <p style={{ color: 'var(--color-text-dark)', fontSize: '16px' }}>
                  Monday – Friday<br />
              ...
              <div style={{ borderTop: '1px solid var(--color-border-light)', paddingTop: '24px' }}>
                ...
                <p style={{ color: 'var(--color-text-dark)', fontSize: '16px', lineHeight: 1.6 }}>
