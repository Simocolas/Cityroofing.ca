...
export default function ReviewsPage() {
  return (
    <div style={{ backgroundColor: 'var(--color-base)', minHeight: '100vh' }}>
      ...
      {/* Rating summary */}
      <div style={{ backgroundColor: 'var(--color-surface)', borderBottom: '1px solid var(--color-border)', padding: '48px 24px', textAlign: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px', flexWrap: 'wrap' }}>
          <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: '72px', color: 'var(--color-text-primary)', lineHeight: 1 }}>
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '64px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '20px' }}>
          {reviewsData.map((review) => (
            <div
              key={review.id}
              style={{ backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '6px', padding: '28px', display: 'flex', flexDirection: 'column', gap: '16px' }}
            >
              ...
              <div style={{ borderTop: '1px solid var(--color-border)', paddingTop: '16px' }}>
                <div style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '14px', color: 'var(--color-text-primary)', marginBottom: '6px' }}>
                  {review.name}
                </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '48px' }}>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            style={{ display: 'inline-block', border: '2px solid var(--color-accent)', color: 'var(--color-accent)', padding: '14px 32px', borderRadius: '4px', textDecoration: 'none', fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '15px' }}
          >
            Read All {companyData.googleReviewCount} Reviews on Google →
          </a>
        </div>
